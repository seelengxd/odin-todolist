...
const DOMStuff = (function(){
  ...
  function addTodo(todo, id, deleteCallback){
    ...
    date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(todo.dueDate, 'dd MMM yyyy');
  ...
  function viewTodo(todo, todoDOM, id){
    ...
    view.dueDate.querySelector('input').value = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(todo.dueDate, 'yyyy-MM-dd');
  ...
  function editTodo(todo, todoDOM){
    ...
    todoDOM.querySelector('p').textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(todo.dueDate, 'dd MMM yyyy');
